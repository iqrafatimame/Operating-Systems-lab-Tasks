...
void calculateTime(int processes[], int n, int arrival_t[], int burst_t[]) {
	...
	cout << "\n\n";
	for (int i = 0; i < n; i++) {
		cout << "processes: " << processes[i] << " ";
		cout << "Burst time: " << burst_t[i] << " ";
		cout << "arrival time: " << arrival_t[i] << endl;
	}
...
int main() {
	...
	cout << endl << "\t\t\t\t-------SHORTEST JOB FIRST AT DIFFERENT ARRIVAL TIME-------- \n\n\n";
